  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="mb-8">
        <h2 className="text-3xl font-bold text-slate-900 mb-1">SEO · {client.name}</h2>
        <p className="text-slate-500 font-medium">Los datos de búsqueda orgánica requieren una fuente conectada.</p>
      </header>
      <section className="rounded-3xl border border-amber-200 bg-amber-50 p-8 text-amber-950" aria-label="Estado de datos SEO">
        <SearchCode className="size-8 mb-4" aria-hidden="true" />
        <h3 className="text-xl font-bold">SEO aún no está disponible</h3>
